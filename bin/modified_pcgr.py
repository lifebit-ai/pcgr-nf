...
def __main__():
   ...
   ## Write arg dict
   with open("arg_dict.json", "w") as json_report:
      json_report.write(json.dumps(arg_dict, separators=(",", ":")))
   ...
   ## Write Config option
   with open("config_options.json", "w") as json_report:
      json_report.write(json.dumps(config_options, separators=(",", ":")))
